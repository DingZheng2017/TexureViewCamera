package live.test.com.inputstreamdemo.core;
...
public final class ExtVideoCapture implements TextureView.SurfaceTextureListener, Camera.PreviewCallback {
...
//    }
    ...
    public ExtVideoCapture(TextureView textureView) {
    ...
    public void switchCamera( SurfaceTexture textureView) {
